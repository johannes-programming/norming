...
OPTS: Final[tuple[str, ...]] = ("__doc__", "__module__")
OBLS: Final[tuple[str, ...]] = ("__name__", "__qualname__")
...
class Norming(BaseNorming):
    ...
    def __call__(self: Self, norm: Callable) -> type:
        ...
        Ans.__new__.__signature__ = sig  # type: ignore[attr-defined]
...
def getclass(norm: Callable, /, *_args: Any, **_kwargs: Any) -> type:
    ...
    class Ans(*_args, **_kwargs):  # type: ignore[misc]
        ...
        def __new__(
            ...
            **kwargs: Any,
            ...
            return super().__new__(cls, data)  # type: ignore[misc]
